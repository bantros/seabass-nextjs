  ...
  'group/field flex w-full gap-3 data-[invalid=true]:text-destructive',
  {
    variants: {
      orientation: {
        ...
        horizontal:
          'grid grid-cols-[3fr_7fr] gap-4 items-center pl-6 pr-2 bg-background rounded-4xl outline-border -outline-offset-2 has-[input:focus-visible]:outline-2 has-[textarea:focus-visible]:outline-2 has-[>[data-slot=button]]:grid-cols-[3fr_6fr_0.5fr] has-[>[data-slot=required]]:grid-cols-[3fr_6fr_0.5fr] has-[>[data-slot=field-content]]:items-start *:data-[slot=field-label]:flex-[1_0_auto] has-[>[data-slot=field-content]]:[&>[role=checkbox],[role=radio]]:mt-px',
        responsive:
