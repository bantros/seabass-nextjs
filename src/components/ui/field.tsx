  ...
  'group/field flex w-full gap-3 data-[invalid=true]:text-destructive',
  {
    variants: {
      orientation: {
        ...
        horizontal:
          'grid grid-cols-[3fr_7fr] gap-4 pl-5 pr-2 bg-gray-100 rounded-4xl has-[>[data-slot=field-content]]:items-start *:data-[slot=field-label]:flex-[1_0_auto] has-[>[data-slot=field-content]]:[&>[role=checkbox],[role=radio]]:mt-px',
        responsive:
